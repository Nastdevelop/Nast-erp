  ...
  <div class="max-w-3xl">
    ...
    <template v-if="loading">
      <div class="flex flex-col gap-4">
        <AppCard><Skeleton height="180px" /></AppCard>
        <AppCard><Skeleton height="120px" /></AppCard>
        <div class="flex justify-end gap-2"><Skeleton width="140px" height="36px" /><Skeleton width="180px" height="36px" /></div>
      </div>
    </template>
    <template v-else>
      <AppCard class="mb-4">
