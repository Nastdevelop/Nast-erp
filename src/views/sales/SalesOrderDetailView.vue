<template>
  <div class="max-w-4xl">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
      <AppCard :loading="loading"><p class="text-xs text-zinc-500 mb-1">Customer</p><p class="font-medium text-sm text-zinc-900 dark:text-white">CV Toko Furnitur Makmur</p></AppCard>
      <AppCard :loading="loading"><p class="text-xs text-zinc-500 mb-1">Order Date</p><p class="font-medium text-sm text-zinc-900 dark:text-white">Sep 16, 2026</p></AppCard>
      <AppCard :loading="loading"><p class="text-xs text-zinc-500 mb-1">Total</p><p class="font-bold text-zinc-900 dark:text-white">Rp 27.600.000</p></AppCard>
    </div>
